...
// Startup code for the executable 'tryPressureSensor'.
...
LE_SHARED le_log_SessionRef_t tryPressureSensor_exe_LogSession;
LE_SHARED le_log_Level_t* tryPressureSensor_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    tryPressureSensor_exe_LogSession = log_RegComponent("tryPressureSensor_exe", &tryPressureSensor_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_barometor.so");
